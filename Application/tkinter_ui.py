...
def show_selection():
    ...
    start_scrapy_process(category, brand, sizes, update_price_label)
...
root = tk.Tk()
root.title("Web Crawling Application")
...
createFilter("Size", 3, sizes)

# B Panel
b_frame = tk.Frame(root, bg="#112233")
b_frame.pack(pady=20)

b_button = tk.Button(b_frame, text="Tahmin Et", command=show_selection)
